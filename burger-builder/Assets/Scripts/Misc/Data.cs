...
public static class Data
{
    ...
    {
        { Ingredients.Bun, new Vector2Int[] { new Vector2Int(0, 0), new Vector2Int( 1, 0), new Vector2Int( 2, 0) } },
        { Ingredients.Beef, new Vector2Int[] { new Vector2Int(0, 0), new Vector2Int(0, -1), new Vector2Int( 1, -1), new Vector2Int( 2, -1) } },
        { Ingredients.Pickle, new Vector2Int[] { new Vector2Int( 0, 0) } },
        { Ingredients.Tomato, new Vector2Int[] { new Vector2Int( 1, 0), new Vector2Int( 2, 0), new Vector2Int( 1, -1), new Vector2Int( 2, -1) } },
        { Ingredients.Onion, new Vector2Int[] { new Vector2Int( 0, 0), new Vector2Int( 1, 1), new Vector2Int(2, 0) } },
        { Ingredients.Chicken, new Vector2Int[] { new Vector2Int( 1, 0), new Vector2Int(0, -1), new Vector2Int( 1, -1), new Vector2Int( 2, -1), new Vector2Int( 2, 0) } },
        { Ingredients.Cheese, new Vector2Int[] { new Vector2Int(0, 0), new Vector2Int( 1, 0), new Vector2Int( 2, -1) } },
    };
...
{
    Bun, Beef, Pickle, Onion, Chicken, Tomato, Cheese
}
